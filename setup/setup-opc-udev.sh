...
SUBSYSTEM=="tty", DRIVERS=="cp210x", KERNELS=="1-1.3.1:*", SYMLINK+="sensor_3_1"
SUBSYSTEM=="tty", DRIVERS=="cp210x", KERNELS=="1-1.3.2:*", SYMLINK+="sensor_3_2"
SUBSYSTEM=="tty", DRIVERS=="cp210x", KERNELS=="1-1.3.3:*", SYMLINK+="sensor_3_3"
SUBSYSTEM=="tty", DRIVERS=="cp210x", KERNELS=="1-1.3.4:*", SYMLINK+="sensor_3_4"
